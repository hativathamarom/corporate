    ...
    return (
        <div className={style["info-container"]}>
            <InfoPage
                title="הספקה בהטסה"
                paragraph={`
                    יחידת הספקה בהטס מתמחה בלוגיסטיקה והספקת משאבים קריטים לכל חלקי הצבא.
                    היחידה מהווה חלק חיוני בתפעול ותחזוקה של מערכות הנשק והציוד ומבטיחה שהחיילים יהיו מצויידים בכל מה שנדרש למשימותיהם.
                    היחיילים ביחידה זאת מקבלים הכשרה מקצועית על ניהול ההספקה לוגיסטיקה ותיפעול משאבים תוך שימת דגש על יעילות ודיוק.
